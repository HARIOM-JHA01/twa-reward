...
export const RewardCard: React.FC<RewardCardProps> = ({ reward }) => {
    ...
    return (
        <div className="flex gap-1 flex-col border-2 border-black rounded-lg mb-2" onClick={() => navigate(`/prize-i-won-reward/${reward.id}`)}>
...
export const DrawCard: React.FC<DrawCardProps> = ({ draw }) => {
    const navigate = useNavigate();
    return (
        <div className="flex gap-1 flex-col border-2 border-black rounded-lg mb-2" onClick={() => navigate(`/prize-i-won-draw/${draw.id}`)}>
