    ...
    return (
        <div className="bg-yellow-300">
            ...
            <main className="bg-yellow-300  flex flex-col w-full min-h-screen p-4">
                ...
                <p className="text-center text-black border p-2 rounded-lg">{rewardDetail.draw_name}</p>
                ...
                <a
                    ...
                    className="text-center text-orange-400 border p-2 rounded-lg">{rewardDetail.channel_link}</a>
                <h2 className="text-center text-black font-bold">Prizes:</h2>
                <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-center text-black p-2 rounded-lg border">
                ...
                <p
                    className="text-center text-black border p-2 rounded-lg"
                ...
                <p
                className="text-center text-black text-sm p-4 rounded-lg"
                >View post, Join Channel and copy paste link, comebak and paste link to bonusforyou</p>
